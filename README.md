...
## Installation 
Il est possible d'installer directement l'application grâce à l'installeur présent dans le dépôt, le nom de celui-ci est le fichier "MediaTek86Installeur.msi".
